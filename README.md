...
```
```bashscript
ros2 launch nav2_costmap_filters_demo costmap_filter_info.launch.py params_file:=src/nav2_keepout_zone/nav2_keepout_zone/params/keepout_params.yaml mask:=src/nav2_keepout_zone/nav2_keepout_zone/maps/keepout_mask.yaml
```
